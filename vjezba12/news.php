<?php 
	...
	if (!isset($action)) {
		...
		if ($action == 1) {
			...
			setcookie('news_link_1', 'index.php?menu=2&action=1', time() + 86400, '/');
			$_COOKIE['news_title_1'] = 'US growth faster than expected';
			$_COOKIE['news_link_1'] = 'index.php?menu=2&action=1';
			print '
			...
			setcookie('news_link_2', 'index.php?menu=2&action=2', time() + 86400, '/');
			$_COOKIE['news_title_2'] = 'Wall Street: Tech firm surge pushes US markets higher';
			$_COOKIE['news_link_2'] = 'index.php?menu=2&action=2';
			print '
			...
			setcookie('news_link_3', 'index.php?menu=2&action=3', time() + 86400, '/');
			$_COOKIE['news_title_3'] = 'Hotel booking sites probed by consumer watchdog';
			$_COOKIE['news_link_3'] = 'index.php?menu=2&action=3';
			print '
